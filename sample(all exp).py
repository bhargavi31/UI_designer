...
class Display_Histogram(QMainWindow):
    def setupUi(self, MainWindow):
        ...
        #self.pbImage.clicked.connect(self.t1.join)
...
###############
##############
working but with button locally
##############
############
...
##############
##############
fail in image process but no crash in ui - different class
#############
#############
...
#########
#############
same class display ui and image process but can reclick start
...
###########
###########
different class display file explorer but no imageprocessing
##########
#########
...
class Display_Histogram(QMainWindow):
    ...
    def start_1(self):
        ...
        histogram_thread = threading.Thread(target=display_histogram_class.display_histogram, args=[self])
        histogram_thread.start()
        # histogram_thread = Display_Histogram()
        # self.pbImage.clicked.connect(histogram_thread.start)
        # self.pbImage.clicked.connect(display_histogram_class.start)
